...
namespace HL7Validator.TriggerEvents.Events.TriggerEventCollection
{
    ...
    public enum ADT_A01EventEnum
    {
        ...
        [Attributes.ValidationTarget(typeof(Segments.PV1.PV1SegmentsEnum))]
        PV1,

        [Attributes.ValidationTarget(typeof(Segments.PV1.Components.PV1_3ComponentsEnum))]
        PV1_3,

        [Attributes.ValidationTarget(typeof(Segments.PV1.Components.PV1_7ComponentsEnum))]
        PV1_7,

        [Attributes.ValidationTarget(typeof(Segments.PV1.Components.PV1_19ComponentsEnum))]
        PV1_19
    }
}
